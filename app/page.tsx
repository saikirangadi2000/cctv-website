  ...
  return (
    <div className="scroll-smooth bg-white text-slate-800 font-sans antialiased">
      ...
      <main className="pt-16 md:pt-8">
        ...
        <section 
          id="home" 
          className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-hidden flex items-center px-8"
        >
        ...
        <section id="products" className="py-24 bg-white px-8">
        ...
        <section className="py-24 bg-slate-50 font-sans overflow-hidden px-8">
        ...
        <section id="mandates" className="py-24 bg-white px-8">
          <div className="container mx-auto px-4 md:px-6">
        ...
        {/* Contact Section */}
        <section id="contact" className="py-24 bg-slate-50 px-8">
          <div className="container mx-auto px-4 md:px-6">
            {/* Content unchanged */}
...
//         <section 
//           id="home" 
//           className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-hidden flex items-center"
//         >
...
//                   {/* Replaced AI Powered with Smart Protection */}
//                   <div className="absolute -top-2 -right-2 bg-gradient-to-r from-[#1c74e9] to-[#3b82f6] text-white px-2 py-0.5 rounded-full text-[10px] font-bold shadow-md">
//                     Smart Protection
//                   </div>
//                 </div>
...
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//               {/* Product Cards */}
//               <div className="p-8 bg-white border border-slate-100 rounded-lg text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
//                 <img alt="Mini Wifi Camera" className="mx-auto mb-6 rounded-lg w-full max-w-[200px]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD6HAq3WhaVvTlG40emFisSMatztxkGGp00O_NXqqWTSdPAZIIG6uOaoI1jO9jZu-dcyjR-rQc15soT89hEVeISLO_oQ7AEQ3CC7y7xgDWTs8lnLo3XSXAfooqRA1ah8T6qbedg42MpExLg61YpBobiDoo8o_qJ7T8imkq6jNctxpTlhsjwoWBW_TbVusePg7f_tMQwheH2rgq2HEKcBMycKvZ5WKFFAicDXDLooRuexwaRq3lpxupznI5UKN-UUp4lY2XnedAIBqI" />
//                 <h3 className="font-bold text-slate-900 text-lg">Mini Wifi Camera</h3>
//                 <p className="text-slate-500 mt-2 text-sm">Compact design for discreet monitoring.</p>
//               </div>

//               <div className="p-8 bg-white border border-slate-100 rounded-lg text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
//                 <img alt="Bullet Wifi Camera" className="mx-auto mb-6 rounded-lg w-full max-w-[200px]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAifGLcidXgUOsaz01i1gXypjP_uw0e4BNugxy_R6B6BQIDAUTP1rrTqmRuzBzxQjS0NFcK9l6tmQNdAPOzpwllbROnBLELwzwPaBl7bN7nMaS5HPS8f5q8DpQEWRjfiYJWtol49rWb6bPrReznCx1Lf-6iVGx1FZA0msyp7LSaa4xYNmYXn0bz945UbBA_cHyaW9m0pzY2DoCpNaahawQclfmcDUcmL8lPy6gL4sBxWhRycooZNN4S7S9Getz3tukP-bUDFXz-_ks" />
//                 <h3 className="font-bold text-slate-900 text-lg">Bullet Wifi Camera</h3>
//                 <p className="text-slate-500 mt-2 text-sm">Weatherproof housing for outdoor security.</p>
//               </div>

//               <div className="p-8 bg-white border border-slate-100 rounded-lg text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
//                 <img alt="Dome Camera" className="mx-auto mb-6 rounded-lg w-full max-w-[200px]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAC0AqF8_sRSsqXQwvCauvXYv7orFFo2Go5k_Ja8pydzywcF3lEMpHFf6RvVlizahKeFxgZWV1MxqcKnzXBRwpsKuV1NYisztH6uyBWNjrB1vbtup3-V1mXWxwrWF21dtloQTQYL5zXgNpsdliAqL-RSw-JwnykCgQPapEd3PtK-c2OCQCptmESXh0vBm5x5azYlFyoKuo_R-EAHTTjGZtjwca6HcdSZjEdaN-xAU7vB4q78_PQTlcngOrSKbPEhl-62Tv3GQV0HI4" />
//                 <h3 className="font-bold text-slate-900 text-lg">Dome Camera</h3>
//                 <p className="text-slate-500 mt-2 text-sm">Vandal-resistant ceiling mount cameras.</p>
//               </div>

//               <div className="p-8 bg-white border border-slate-100 rounded-lg text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
//                 <img alt="PTZ Camera" className="mx-auto mb-6 rounded-lg w-full max-w-[200px]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDyvjSDRr1o482IQ3BBTVY_a9fX2d6bFEL6efUpB-qxslyWbjfm4LWMy9hWeEVDuHY70RLmNsSp7l_7XikfgjYJm4qXSDVFVda0g5RFy0v1cKaZY5NMxtVILOSSE6yugNG8Fu0EufOcY_DpfX7Ug1qBqLjls_gKS1V0gg4xr92Kltcqt8Z8KQzeg8JKigxJL7sAr30b4s8ZyvKNuMZvaD9n2r_sHvRSA0yabDwsVfQt2JCze3KN-kUri8Va1vLMCRKf9ehyWvjCCLA" />
//                 <h3 className="font-bold text-slate-900 text-lg">PTZ Security Camera</h3>
//                 <p className="text-slate-500 mt-2 text-sm">Pan, tilt, and zoom for wide area coverage.</p>
//               </div>

//               <div className="p-8 bg-white border border-slate-100 rounded-lg text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
//                 <img alt="Wireless Camera" className="mx-auto mb-6 rounded-lg w-full max-w-[200px]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD95NPStOC1NHkO4jzoZiCEGq2D_SF_Ccvv0x_tAPUlywxu8DZZlIHMROux6x9BIYCC2pjvBeYodNcYrvj9VkvBM84tP3p4cD2e0ITRw07FXrHjvzLOOeOx3vWQXq-QHDyXeYVB7U9OobHk2-f2dbAE47CHoMlIO_7udhUUy13ZIwwvTj7Zxw37I4-oO6mPnSxqC_A4ODJPbaL8OSs2S_nSaoJyah-HyUrw2pkSHsElmbDO_1WYgQ5o-YU1zr0dfmww6rEUOpJCgSI" />
//                 <h3 className="font-bold text-slate-900 text-lg">Wireless Cameras</h3>
//                 <p className="text-slate-500 mt-2 text-sm">Easy installation with no signal cables.</p>
//               </div>

//               <div className="p-8 bg-white border border-slate-100 rounded-lg text-center shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
//                 <img alt="Solar Camera" className="mx-auto mb-6 rounded-lg w-full max-w-[200px]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB8lO04AdO1C5kpd1QyNOFegP1ZcK3slsme57Kvnu9RYCObApxj2zlEiuLVpMoha2aYJhAis2tvc44UmUgrzVFOyBJsPLLX-4cMDe-szU-dZaOKvxNrGpCKqHNaCpoBHLvE61E5d4OFxEw0EXuHsXKgm0Ye3Pu4fWTKRHKoopwOWPetAPXmzFrdmdWShMce61aAvN--0Cmg8Ma1nSn3uzUCemVLapkPrN0g5neY6M_jEaGwbDpnZ6I8oo3WDOvPNzGt6h7Xy6liMfU" />
//                 <h3 className="font-bold text-slate-900 text-lg">Solar Cameras</h3>
//                 <p className="text-slate-500 mt-2 text-sm">Self-powered for remote off-grid sites.</p>
//               </div>
//             </div>
//           </div>
//         </section>
...
//                 <div className="h-48 overflow-hidden">
//                   <img alt="HD Installation" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBBWCIxZx_Yzeb1FXd2wzVU_llNnzJx72P35I5FdI8CCbGC4tyFUy7e-tkBytoguCJ3HR4dlu_iG6UJrOVF2Zne2xAFsX8f94aT9yj3jorwUKooaMTxMo78957b5zj_vUY96bcewpalPXNlXljltUTozIzsTMb49dY_GuQ5y1Yo0MFQY90L7T_ZzDgguiANq1mrH2TiBl7V8DrqKGnn_mJD3TLyH-hds3X7qQzNcS4v0pGLVHKYqWzxqO_IE0_16FyTAbW8B4Vgsf4" />
//                 </div>
//                 <div className="p-6">
//                   <h3 className="text-xl font-bold mb-3 text-slate-900">HD Camera Installation</h3>
//                   <p className="text-slate-600 text-sm leading-relaxed mb-4">Crystal-clear local recording for homes and businesses.</p>
//                 </div>
//               </div>

//               <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow group">
//                 <div className="h-48 overflow-hidden">
//                   <img alt="IP Systems" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDzjfsPDgIUweaSEGauE6j9AQCuASCJV7GOQG8zVBK6qvcIRtrZBDf-QLHJ48serhOoLj2w1LU03vDg8U5qivuMd4kijnFrZEX0n-heMJi8iPXfJeIrZGWHIofzU-6-7jdM8bw2b-m66xV-dG0G0SbgSS2frUEm6OAC-XrFs_w5vrx7IkN5dddbDCZr41XnvE9RQMYzbnmvuJyl9tZII3G77ok5gSzCvk-usyw3jvB_kft4cP-4zwswq2VHJ3MsvXPXzlxCVujAMmY" />
//                 </div>
//                 <div className="p-6">
//                   <h3 className="text-xl font-bold mb-3 text-slate-900">IP Camera Systems</h3>
//                   <p className="text-slate-600 text-sm leading-relaxed mb-4">Scalable network solutions for enterprise environments.</p>
//                 </div>
//               </div>

//               <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow group">
//                 <div className="h-48 overflow-hidden">
//                   <img alt="Maintenance" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDmawEtkXufgsHLXt2c7skK467uOrlT4e82sqY9hyV3sMn_VF_pZBKQC6S4HwjXBUo8xho7pusp9roid3cNgBwuTzsmRFBcqfgz4AE8eJCx_vv5qVeV5fZS5-ObWXj_ZjLXj60EJjmKxtvGhxzVT3GUpqm4pWkmf6i6r3jAM9uzYz4SyekYYAXJUavsJFUFhB7FZHRmKYgdtIFArlPXiCDrr-mRX5SW25xggBvMBL3DcWe4Ek6DhWaCf681WfoE6VSqGbfwkOvH30U" />
//                 </div>
//                 <div className="p-6">
//                   <h3 className="text-xl font-bold mb-3 text-slate-900">System Maintenance</h3>
//                   <p className="text-slate-600 text-sm leading-relaxed mb-4">Regular health checks to ensure 24/7 reliability.</p>
//                 </div>
//               </div>

//               <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow group">
//                 <div className="h-48 overflow-hidden">
//                   <img alt="Off-Grid Solar" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBrFpe7PxzHfbL3s6qBxKqllhJi3I9m_dvNU3mrO8D0-MBY8gGybnL9KLtRCMu28E4xCDhSGLVRC4EvrQnHzMYcKubmIrlfCKbrpYSrXb2u5r0aKX3c47nYs5XFM6_B2-lkuQdCwNHcWkwME-QNMajAeUqmQZgkA9exEKlwFSP0vS1NYJZfgavDedUQM-b9JCFl-NuU7KrKnk18oajgdccToX-4H8zMtWgHibnbWYFQSKCE5UAorA03v-9auWDO7kZCKM7Pj4VFJVI" />
//                 </div>
//                 <div className="p-6">
//                   <h3 className="text-xl font-bold mb-3 text-slate-900">Solar Surveillance</h3>
//                   <p className="text-slate-600 text-sm leading-relaxed mb-4">Off-grid surveillance for remote open areas.</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//         {/* 2026 Security Intelligence Hub - Updated Theme */}
...
//         <section id="mandates" className="py-24 bg-white">
//           <div className="container mx-auto px-4 md:px-6">
//             <div className="text-center max-w-3xl mx-auto mb-12">
//               <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">2026 Security Mandates</h2>
//               <p className="text-slate-600 text-lg">
